...
export const Projects: ProjectInfo[] = [
	{
		...
		description:
			'Simulation of the training process of AND gate neural network, implemented with hebb network.', // TODO Complete the description
	...
	},
	{
		...
		description:
			'Simulation of the training process of ---, implemented with hebb network.', // TODO Complete the description
		algorithm: 'Hebb Algorithm',
